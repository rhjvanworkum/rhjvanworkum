...
**ML Engineer working on machine learning for chemistry & materials** [@duniatechnologies](https://github.com/duniatechnologies), based in Berlin.

I build models and simulation tooling at the intersection of deep learning, quantum chemistry & experimental data — currently focused on multi-modal models for materials discovery.

---

### What I work on

- **ML for materials & molecules** — representation learning and property prediction for chemical systems
- **Bridging the sim2real gap** — using ML to transfer knowledge between simulation and experiment
- **Research → production** — turning methods from papers into tooling people actually use
...
- 📄 [Google Scholar](https://scholar.google.com/citations?user=gqeV3HoAAAAJ)
- 💼 [LinkedIn](https://www.linkedin.com/in/ruard-van-workum-6a9889174/)
